...
type: feuille
jeu: "Cthulhu Hack — campagne Wendigo, scénario 5"
pied: "GRAND FROID — feuille de conduite"
lang: fr
---
...
**Wacker Drive → tour Harold → hall → ascenseur → 30ᵉ → le bureau.**\
Dans l'ascenseur : les murs en miroir. Une ligne, on passe.

### Harold donne

**Trois morts.** Walter Nunez, trader — ascenseur, samedi soir.\
Dorothea Brickford, Statistiques — déneigeuse, dimanche.\
Sherlyn Moore, cliente — piscine gelée, ce matin.

**Une lettre signée.** Toutes les portes de la société, aucun jet.\
**Deux consignes.** Tout de suite. Discrètement — ses employés ignorent les morts.

**Deux jours et demi** : lundi après-midi, mardi, mercredi (B1).
